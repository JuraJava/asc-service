...
//                .build();
//
//        CompletedWork work = CompletedWork.builder()
//                .id(2L)
...
//
//        // Новые проверки на изменённые количества
//        SparePart updatedPart = updated.getSpareParts().get(0);
//        assertEquals(9L, updatedPart.getRemainingQuantity());
//        assertEquals(1L, updatedPart.getReserveQuantity());
//    }
//    @Test
