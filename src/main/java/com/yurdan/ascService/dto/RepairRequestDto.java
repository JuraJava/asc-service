...
/**
 * Класс — это DTO, предназначенный для получения данных от клиента, при создании новой заявки на ремонт через API,
 * используется в контроллере, чтобы принять POST-запрос от клиента.
 */
@Builder
@Getter
@Setter
